from project_2.customer import Customer
from project_2.dvd import DVD
from project_2.movie_world import MovieWorld
...
class TestsMovieWorld(unittest.TestCase):
    def test_customer_init(self):
        ...
        self.assertEqual(c.family_name, "Pesho")
    ...
    def test_dvd_init(self):
        ...
        self.assertEqual(dvd.family_name, "B")
    ...
    def test_dvd_class_method(self):
        ...
        self.assertEqual(dvd.family_name, "A")
        self.assertEqual(dvd.id, 1)
    ...
    def test_movie_init(self):
        ...
        self.assertEqual(movie.family_name, "Test")
